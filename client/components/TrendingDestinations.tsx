...
// Maine yahan IDs ko travelPackages.ts wali real IDs se replace kiya hai
const destinations: Destination[] = [
  { id: "goa-beach", city: "Goa", country: "India", flag: "🇮🇳", image: "https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?w=700&q=80", span: "wide" },
  { id: "ladakh-adventure", city: "Ladakh", country: "India", flag: "🇮🇳", image: "https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?w=800&q=80", span: "tall" },
  { id: "manali-hills", city: "Manali", country: "India", flag: "🇮🇳", image: "https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=700&q=80", span: "normal" },
  { id: "dubai-luxury", city: "Dubai", country: "UAE", flag: "🇦🇪", image: "https://images.unsplash.com/photo-1518684079-3c830dcef090?w=900&q=80", span: "wide" },
  { id: "bali-bliss", city: "Bali", country: "Indonesia", flag: "🇮🇩", image: "https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=700&q=80", span: "normal" },
  { id: "singapore-city", city: "Singapore", country: "Singapore", flag: "🇸🇬", image: "https://images.unsplash.com/photo-1525625293386-3f8f99389edd?w=700&q=80", span: "normal" },
  { id: "paris-romance", city: "Paris", country: "France", flag: "🇫🇷", image: "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=700&q=80", span: "normal" },
  { id: "swiss-alps", city: "Swiss Alps", country: "Switzerland", flag: "🇨🇭", image: "https://images.unsplash.com/photo-1501785888041-af3ef285b470?w=900&q=80", span: "wide" },
  { id: "japan-cultural-treasure", city: "Tokyo", country: "Japan", flag: "🇯🇵", image: "https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=900&q=80", span: "normal" },
  { id: "australia-coast", city: "Sydney", country: "Australia", flag: "🇦🇺", image: "https://images.unsplash.com/photo-1506976785307-8732e854ad03?w=700&q=80", span: "normal" },
];

function DestCard({ dest, index }: { dest: Destination; index: number }) {
  return (
    <Link 
      href={`/service/${dest.id}`} 
      className={`relative group rounded-[32px] overflow-hidden cursor-pointer block
        ${dest.span === "wide" ? "md:col-span-2 md:row-span-1" : "col-span-1"}
        ${dest.span === "tall" ? "md:row-span-2" : "row-span-1"}
      `}
    >
